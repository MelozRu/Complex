...
int main() {
  ...
  */
  ...
  Complex c8;
  c8 = c3 - c2;                                      
  cout << "Результат вычитания с помощью перегруженного оператора: c8 = c3 - c2 = ";
  c8.output();

  Complex c9;
  c9 = c3 * c2;
  cout << "Результат умножения с помощью перегруженного оператора: c9 = c3 * c2 = ";
  c9.output();

  Complex c10;
  c10 = c3 / c2;
  cout << "Результат деления с помощью перегруженного оператора: c10 = c3 / c2 = ";
  c10.output();

  Complex c11;
  c11 = c3 == c2;
  cout << "Результат сравнения с помощью перегруженного оператора: c11 = c3 == c2 = ";
  bool res;
  res = c1 == c2;
  if (res == 1) {
